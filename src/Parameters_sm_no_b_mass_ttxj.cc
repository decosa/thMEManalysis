...
Parameters_sm_no_b_mass_ttxj * Parameters_sm_no_b_mass_ttxj::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_no_b_mass_ttxj * Parameters_sm_no_b_mass_ttxj::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_no_b_mass_ttxj(); 

  return instance; 
}

void Parameters_sm_no_b_mass_ttxj::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_no_b_mass_ttxj::setIndependentCouplings()
{

}
void Parameters_sm_no_b_mass_ttxj::setDependentParameters()
{
  sqrt__aS = sqrt(aS); 
  G = 2. * sqrt__aS * sqrt(M_PI); 
  G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_no_b_mass_ttxj::setDependentCouplings()
{
...
void Parameters_sm_no_b_mass_ttxj::printIndependentParameters()
{
  if (DEBUG){
...
void Parameters_sm_no_b_mass_ttxj::printIndependentCouplings()
{
  if (DEBUG){
...
void Parameters_sm_no_b_mass_ttxj::printDependentParameters()
{
  if (DEBUG){
...
void Parameters_sm_no_b_mass_ttxj::printDependentCouplings()
{
  if (DEBUG){
