...
#ifndef Parameters_sm_no_b_mass_ttxj_H
#define Parameters_sm_no_b_mass_ttxj_H
...
class Parameters_sm_no_b_mass_ttxj
{
  public:

    static Parameters_sm_no_b_mass_ttxj * getInstance(); 
  ...
  private:
    static Parameters_sm_no_b_mass_ttxj * instance; 
}; 
